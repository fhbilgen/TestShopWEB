...
namespace TestWEB.Pages
{
    public class SomeRemoteCallsModel : PageModel
    {
        ...
        private static string reqUrl = Environment.GetEnvironmentVariable("TestShopApi_LongExecution"); 
        private static string reqUrl2 = Environment.GetEnvironmentVariable("TestShopApi_ThrowException"); 
        private static string reqUrl3 = Environment.GetEnvironmentVariable("TestShopApi_DoubleHop"); 
        private static string reqUrl4 = Environment.GetEnvironmentVariable("TestShopApi_ChattyDoubleHop"); 
